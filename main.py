...
if __name__ == "__main__":
    ...
    if ticker == "":
        ...
        predi = pred_sarimax(time_period, predictions_time, ticker, pru)
        tech = tech_analysis(time_period, ticker)
        ...
        pdf = PdfPages(f"{path}\{ticker}_predictions_{time_period}_{predictions_time}_{num_of_tweets}.pdf")
